...
import { ChangePassword, getUserById, updateUser } from "../../api/user";
...
const EditProfile = () => {
  ...
  return (
    <div className="px-sm-0 px-md-5 row">
      <div className="col-sm-7 px-3">
        ...
        <form onSubmit={handleUpdate}>
          ...
          <div className="row">
            <div className="col-sm-3">
              {viewFile ? (
                ...
                <img
                  src={`http://${window.location.hostname}:5000/userimages/${data.photo}`}
                  alt="hugenerd"
                  width="90"
                  height="90"
                  className="rounded-circle"
          ...
          <button
            className="btn btn-dark mt-5 rounded-5 text-center btn-lg"
            type="submit"
          >
            SAVE SETTINGS
          </button>
        </form>
        <h1 className="mt-3 mb-3">Change Password</h1>
        <form onSubmit={change}>
          <input
            name="_id"
            value={(changePassword._id = user._id)}
            hidden
          ></input>
          <div className="mb-3">
          ...
          <button
            className="btn btn-dark mt-3 rounded-5 text-center btn-lg"
            type="submit"
          >
            Change Password
          </button>
